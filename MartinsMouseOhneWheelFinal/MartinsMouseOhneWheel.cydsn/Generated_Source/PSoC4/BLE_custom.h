...
#define CYBLE_MOUSE_SERVICE_SERVICE_INDEX   (0x00u) /* Index of Mouse_Service service in the cyBle_customs array */
#define CYBLE_MOUSE_SERVICE_MOUSE_DATA_CHAR_INDEX   (0x00u) /* Index of Mouse_Data characteristic */
#define CYBLE_MOUSE_SERVICE_MOUSE_DATA_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x00u) /* Index of Client Characteristic Configuration descriptor */
#define CYBLE_MOUSE_SERVICE_MOUSE_DATA_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x01u) /* Index of Characteristic User Description descriptor */


#define CYBLE_MOUSE_SERVICE_SERVICE_HANDLE   (0x000Cu) /* Handle of Mouse_Service service */
#define CYBLE_MOUSE_SERVICE_MOUSE_DATA_DECL_HANDLE   (0x000Du) /* Handle of Mouse_Data characteristic declaration */
#define CYBLE_MOUSE_SERVICE_MOUSE_DATA_CHAR_HANDLE   (0x000Eu) /* Handle of Mouse_Data characteristic */
#define CYBLE_MOUSE_SERVICE_MOUSE_DATA_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x000Fu) /* Handle of Client Characteristic Configuration descriptor */
#define CYBLE_MOUSE_SERVICE_MOUSE_DATA_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0010u) /* Handle of Characteristic User Description descriptor */
