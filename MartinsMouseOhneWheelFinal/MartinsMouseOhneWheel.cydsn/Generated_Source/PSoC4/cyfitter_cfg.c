...
static void ClockSetup(void)
{
	...
	CY_SET_REG32((void *)(CYREG_WDT_MATCH), 0x028E0000u);
	CY_SET_REG32((void *)(CYREG_WDT_CONFIG), 0x40000500u);
...
void cyfitter_cfg(void)
{
	...
	CY_SET_REG32((void *)(CYREG_GPIO_PRT0_PC), 0x00012000u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT0_INTR_CFG), 0x00000E00u);

	/* IOPINS0_1 Starting address: CYDEV_GPIO_PRT1_BASE */
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT1_BASE), 0x00000010u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT1_PC), 0x00002009u);
	...
	CY_SET_REG32((void *)(CYREG_GPIO_PRT3_PC), 0x00200000u);
